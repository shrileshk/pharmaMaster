<?php include("custheaderhead.php"); ?>
    ...
    <div class="site-blocks-cover inner-page" style="background-image: url('resources/images/hero_1.jpg');">
      <div class="container">
        <div class="row">
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="resources/images/bg_1.jpg" alt="Image placeholder" class="img-fluid rounded">
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6 order-md-2">
            <div class="block-16">
              <figure>
                <img src="resources/images/hero_1.jpg" alt="Image placeholder" class="img-fluid rounded">
                <a href="https://vimeo.com/channels/staffpicks/93951774" class="play-button popup-vimeo"><span
                    class="icon-play"></span></a>
